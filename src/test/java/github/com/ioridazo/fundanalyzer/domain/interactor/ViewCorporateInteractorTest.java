...
class ViewCorporateInteractorTest {
    ...
    @BeforeEach
    void setUp() {
        analyzeInteractor = Mockito.mock(AnalyzeInteractor.class);
        ...
        void of() {
            ...
            assertAll(
                    ...
                    () -> assertAll(
                            ...
                            () -> assertEquals(BigDecimal.TEN, actual.getCorporate().getAverageCorporateValue()),
                            () -> assertEquals(BigDecimal.TEN, actual.getCorporate().getStandardDeviation()),
                            () -> assertEquals(BigDecimal.TEN, actual.getCorporate().getDiscountValue()),
                            () -> assertEquals(BigDecimal.TEN, actual.getCorporate().getDiscountRate())
                    ),
                    () -> assertAll(

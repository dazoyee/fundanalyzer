...
//    ("その他"),
//    ("貸倒引当金"),
    TOTAL_CURRENT_ASSETS("2", "1", "流動資産合計"),
    //    BUILDINGS("建物"),
//    ("減価償却累計額"),
//    ("建物（純額）"),
//    ("建物附属設備"),
...
//    ("信託差入敷金及び保証金"),
//    ("長期前払費用"),
    TOTAL_INVESTMENTS_AND_OTHER_ASSETS("6", null, "投資その他の資産合計"),
    //    ("固定資産合計"),
//    ("投資法人債発行費"),
//    ("繰延資産合計"),
//    ("資産合計"),
...
//    ("前受金"),
//    ("その他"),
    TOTAL_CURRENT_LIABILITIES("11", "1", "流動負債合計"),
    //    ("投資法人債"),
//    ("長期借入金"),
//    ("預り敷金及び保証金"),
//    ("資産除去債務"),
    TOTAL_FIXED_LIABILITIES("13", "1", "固定負債合計"),
    TOTAL_LIABILITIES("14", null, "負債合計"),
//    ("出資総額"),
//    ("圧縮積立金"),
//    ("任意積立金合計"),
//    ("当期未処分利益又は当期未処理損失（△）"),

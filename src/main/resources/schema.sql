...
(
    ...
    `star`            CHAR(1)      NOT NULL DEFAULT '0' COMMENT '注目' CHECK (`star` IN ('0', '1')),
    `created_at`      DATETIME     NOT NULL DEFAULT CURRENT_TIME() COMMENT '登録日',
...
(
    ...
    `quarter_type`           CHAR(1)                  DEFAULT NULL COMMENT '四半期種別' CHECK (`quarter_type` IN ('1', '2', '3', '4', 'H')),
    `submit_date`            DATE            NOT NULL COMMENT '提出日',
    `document_id`            CHAR(8)         NOT NULL COMMENT '書類ID',
...
(
    ...
    `stock_price`           FLOAT           NOT NULL COMMENT '終値',

...
insert into bs_subject (outline_subject_id, detail_subject_id, name) values
  ('1', '3', '流動資産'), ('1', '1', '流動資産合計'), ('2', null, '有形固定資産'), ('3', null, '無形固定資産'),
  ('4', '2', '投資その他の資産'), ('4', '1', '投資その他の資産合計'),
  ('5', '1', '固定資産合計'), ('6', null, '繰延資産'), ('7', null, '資産合計'),
  ('8', '3', '流動負債'), ('8', '1', '流動負債合計'),
  ('9', '3', '固定負債'), ('9', '1', '固定負債合計'), ('10', null, '負債合計'),
  ('11', null, '投資主資本'), ('12', null, '剰余金'), ('13', null, '投資主合計'), ('14', null, '純資産合計'), ('15', null, '負債純資産合計'),
  ('1', '2', '流動資産計'), ('5', '2', '固定資産計'), ('8', '2', '流動負債計'), ('9', '2', '固定負債計')
...
--  (null, '2', '会計監査人報酬'), (null, '2', 'その他営業費用'), (null, '2', '営業費用合計'),
  ('3', '1', '営業利益'),
  ('3', '2', '営業利益又は営業損失（△）'), ('3', '3', '営業利益又は営業損失(△)'), ('3', '4', '営業損失（△）'), ('3', '5', '営業損失(△)'), ('3', '6', '営業利益（△は損失）'),
  ('4', null, '営業外収益'),

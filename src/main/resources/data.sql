...
insert into bs_subject (outline_subject_id, detail_subject_id, name) values
  ('1', null, '流動資産'), ('2', '1', '流動資産合計'), ('3', null, '有形固定資産'), ('4', null, '無形固定資産'),
  ('5', null, '投資その他の資産'), ('6', null, '投資その他の資産合計'),
  ('7', '1', '固定資産合計'), ('8', null, '繰延資産'), ('9', null, '資産合計'),
  ('10', null, '流動負債'), ('11', '1', '流動負債合計'),
  ('12', null, '固定負債'), ('13', '1', '固定負債合計'), ('14', null, '負債合計'),
  ('15', null, '投資主資本'), ('16', null, '剰余金'), ('17', null, '投資主合計'), ('18', null, '純資産合計'), ('19', null, '負債純資産合計'),
  ('2', '2', '流動資産計'), ('7', '2', '固定資産計'), ('11', '2', '流動負債計'), ('13', '2', '固定負債計')
...
--  (null, '2', '会計監査人報酬'), (null, '2', 'その他営業費用'), (null, '2', '営業費用合計'),
  ('3', '1', '営業利益'),
  ('3', '2', '営業利益又は営業損失（△）'), ('3', '3', '営業利益又は営業損失(△)'), ('3', '4', '営業損失（△）'),
  ('4', null, '営業外収益'),
